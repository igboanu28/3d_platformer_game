...
namespace AdvancedController
{
    ...
    {
        #region Fields
        [SerializeField] AdvanceInputReader input;
        ...
        void SetupStateMachine()
        {
            ...
            At(grounded, jumping, () => (jumpKeyIsPressed || jumpKeyIsPressed) && !jumpInputIsLocked);
        ...
        void At(IStates from, IStates to, Func<bool> condition) => stateMachine.AddTransition(from, to, condition);
        void Any<T>(IStates to, Func<bool> condition) => stateMachine.AddAnyTransition(to, condition);
