...
namespace AdvancedController
{
    ...
    {
        [SerializeField, FormerlySerializedAs("cameraTransform")] Transform cameraTransform;
        [SerializeField, FormerlySerializedAs("cameraTargetTransform")] Transform cameraTargetTransform;
